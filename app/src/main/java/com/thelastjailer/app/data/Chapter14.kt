 ...
 * A vision it offers manifests as this chapter's combat: a symbolic, non-physical confrontation with
 * a memory-construct of whatever severed the six wards from something closer to a choice, three
 * centuries ago — new worldbuilding rather than a resolved mystery, deliberately left open. Fourteenth
 * and toughest combat encounter yet (The Memory Itself, 190 HP). Ends with the prisoner's stance
 * toward Kaelen shifted from adversary/tempter to something closer to a wary ally.
 */
val chapter14Nodes: List<StoryNode> = listOf(
    StoryNode(
        ...
        narrativeText = """
            It doesn't stop at one sentence. Night after night, the pressure behind the black door
            keeps finding new ways to press against the wards — not testing them the way it used
            to, not asking for anything. Just talking, the way something talks when it's finally
            decided silence isn't working for it anymore.

            "Four settings," it says again, the third night running. "You felt it too. I know you
            did. Ask me what happens at six."
        """.trimIndent(),
        choices = listOf(
            Choice(
                label = "\"What happens at six?\"",
                nextNodeId = "what_it_says",
    ...
    StoryNode(
        ...
        narrativeText = """
            Whether Kaelen asks or only listens, it answers anyway. "At six, whatever she's
            building doesn't stay a cage. It becomes a door with no other side — six of us,
            poured into one shape, and whatever walks out afterward won't remember being any of
            us individually. I have been many things in three centuries behind this stone. I
            would rather not become someone else's furniture."
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            it again after all. "Ask me that again," it says finally, "after there are fewer of us
            left to lose. I'll answer honestly. I promise you that much costs me nothing."
        """.trimIndent(),
        choices = listOf(
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            to admit since. He presses his palm flat against the black iron anyway.
        """.trimIndent(),
        choices = listOf(
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            where the iron bit into it, the vision already fraying at the edges the way dreams do.
            He remembers enough. Six wards, once something closer to a choice than a cage.
            ...
            The prisoner doesn't say anything else that night. It doesn't need to.
        """.trimIndent(),
        choices = listOf(
            Choice(
