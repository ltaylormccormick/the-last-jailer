 ...
 * but never located). This reframes the endgame: the sixth and final fragment was never hidden
 * behind a warden's gate at all. It has spent three hundred years disguised as the place itself,
 * having forgotten so completely what it is that even the whole no longer recognizes it as a
 * fragment. Twenty-sixth and toughest combat yet (The Unremembering, 355 HP — not a guardian
 * defending the site, but the site's own defensive forgetting given shape, resisting the idea that
 * it was ever anything else). Deliberately does not resolve the confrontation with a clean answer:
 * this is the setup chapter for the true endgame, not the endgame itself.
 */
val chapter26Nodes: List<StoryNode> = listOf(
    StoryNode(
        ...
        choices = listOf(
            Choice(
                ...
                nextNodeId = "what_the_prisoner_remembers",
    ...
    StoryNode(
        id = "what_the_prisoner_remembers",
        chapterId = "chapter_26",
        title = "What the Prisoner Remembers",
        illustrationId = "what_the_prisoner_remembers_ch26",
        narrativeText = """
            "The place where it happened. Where something tore itself into six pieces on purpose,
            so it could never again be whole enough to do whatever it did before that. Emberlow,
            Greymoor, Duskmere, your own door — those are gates someone built afterward, to keep a
            fragment company. This is different. Nobody built anything at the Sundering Ground.
            Nobody needed to. The sixth piece never left."
        """.trimIndent(),
        choices = listOf(
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            everything it has, that there's nothing here to defend — that this is only a
            hillside, that Kaelen is mistaken, that the thread in his hand is nothing at all. Three
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            when they've lost the thread of what they were about to say. For one unguarded moment,
            the hillside is just a hillside again, and something underneath it is listening,
            without yet knowing to what.
        """.trimIndent(),
        choices = listOf(
            Choice(
                label = "\"You were part of something once. You still are. I'm not leaving until you remember that.\"",
                nextNodeId = "chapter26_end",
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            years forgetting on purpose, and one conversation, however carefully chosen, was never
            going to undo that in an afternoon.
