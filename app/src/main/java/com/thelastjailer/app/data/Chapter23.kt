 ...
 * years, far longer than Kaelen's three. Its resistance is far more fragile. Racing to Emberlow the
 * instant the prisoner warns him versus making it explain first changes the tenor of the sprint
 * there, and once Kaelen decides how to stand with Emberlow's sibling — refusing to leave, insisting
 * she choose for herself, or simply staying silent and present — that choice now colors how the
 * chapter's ambiguous close actually reads, not just which flag it leaves behind. This reframes the
...
val chapter23Nodes: List<StoryNode> = listOf(
    StoryNode(
        ...
        narrativeText = """
            ...
            She's close to saying yes." Its urgency is a language of its own by now, one Kaelen
            has learned to trust without needing translation.
        """.trimIndent(),
        choices = listOf(
            Choice(
                label = "\"Then we go. Now.\"",
                nextNodeId = "what_the_prisoner_senses_raced",
            ...
            Choice(
                ...
                nextNodeId = "what_the_prisoner_senses_asked",
                consequences = Consequences(
    ...
    StoryNode(
        id = "what_the_prisoner_senses_raced",
        chapterId = "chapter_23",
        title = "What the Prisoner Senses",
        illustrationId = "what_the_prisoner_senses",
        narrativeText = """
            There's no pause for detail, and the prisoner doesn't offer any it wasn't given time
            to give. "Emberlow's warden died alone eleven years ago, and nobody sent to replace
            him," it says, keeping pace with Kaelen's own hurry. "The sibling behind that gate has
            had eleven years of exactly the silence I've had three centuries of, except she
            started this fight already tired. I don't know if she says no the way I did. I don't
            know if I would have, either, at eleven years."
        """.trimIndent(),
        choices = listOf(
    ...
    StoryNode(
        id = "what_the_prisoner_senses_asked",
        chapterId = "chapter_23",
        title = "What the Prisoner Senses",
        illustrationId = "what_the_prisoner_senses",
        narrativeText = """
            It answers the question fully before either of them moves, and something in being
            allowed the time seems to steady it. "Emberlow's warden died alone eleven years ago,
            and nobody sent to replace him," it says. "The sibling behind that gate has had eleven
            years of exactly the silence I've had three centuries of, except she started this
            fight already tired. I don't know if she says no the way I did. I don't know if I
            would have, either, at eleven years."
        """.trimIndent(),
        choices = listOf(
            Choice(label = "Go to Emberlow.", nextNodeId = "the_road_to_emberlow")
        )
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            Whatever's happening here, it's already been happening for longer than tonight, and
    ...
    StoryNode(
        ...
        narrativeText = """
            The stragglers break before the gate does. Up close, Emberlow's ward is barely
            holding, not shattered, not breached, just tired in a way Kaelen recognizes
            uncomfortably well from three years of standing watch over his own. Whatever's on the
            other side has been listening to every word the whole has said to it, alone, for
            eleven years, with nobody standing where Voss and Kaelen have stood for him.
        """.trimIndent(),
        choices = listOf(
            Choice(
                label = "\"You don't have to decide alone anymore. I'm not leaving until you know that.\"",
                nextNodeId = "chapter23_end_refused_leave",
            ...
            Choice(
                ...
                nextNodeId = "chapter23_end_insisted_choice",
            ...
            Choice(
                ...
                nextNodeId = "chapter23_end_waited",
                consequences = Consequences(setFlags = setOf("waited_at_emberlow"))
            )
        )
    ),
    StoryNode(
        id = "chapter23_end_refused_leave",
        chapterId = "chapter_23",
        title = "End of Chapter XXIII — The First to Say Yes",
        illustrationId = "chapter23_threshold",
        narrativeText = """
            Emberlow's sibling doesn't answer that night, or the next, but Kaelen doesn't leave
            the threshold either, camped there through both of them the way he once stood watch
            over his own door before he had any reason to expect an answer at all.

            What she does do, by the third morning, is stop answering the whole entirely, a
            silence Kaelen chooses to read as a maybe rather than a yes, mostly because the
            alternative is worse than he can afford to sit with right now, and because he was
            still there to see it happen.
    ...
    StoryNode(
        id = "chapter23_end_insisted_choice",
        chapterId = "chapter_23",
        title = "End of Chapter XXIII — The First to Say Yes",
        illustrationId = "chapter23_threshold",
        narrativeText = """
            Emberlow's sibling doesn't answer that night, or the next. Kaelen keeps repeating the
            same idea in different words each time he checks, careful never to make it sound like
            pressure dressed up as patience: that whatever she decides, it has to actually be
            hers.

            What she does do, by the third morning, is stop answering the whole entirely, a
            silence Kaelen chooses to read as a maybe rather than a yes, mostly because the
            alternative is worse than he can afford to sit with right now.
    ...
    StoryNode(
        id = "chapter23_end_waited",
        chapterId = "chapter_23",
        title = "End of Chapter XXIII — The First to Say Yes",
        illustrationId = "chapter23_threshold",
        narrativeText = """
            Emberlow's sibling doesn't answer that night, or the next, and Kaelen says nothing
            further to fill the silence, trusting that presence without pressure might be its own
            kind of argument.
