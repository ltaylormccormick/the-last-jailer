...
object StoryRepository {
    val chapters: List<Chapter> = listOf(chapter1, chapter2, chapter3, chapter4, chapter5, chapter6, chapter7)

    private val nodesById: Map<String, StoryNode> =
        (chapter1Nodes + chapter2Nodes + chapter3Nodes + chapter4Nodes + chapter5Nodes + chapter6Nodes + chapter7Nodes)
            .associateBy { it.id }
