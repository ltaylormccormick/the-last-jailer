...
private val firstBloodEncounter = CombatEncounter(
    ...
    defeatNodeId = "first_blood_defeat",
    xpReward = 40,
    goldReward = 10,
...
private val sealBreakerEncounter = CombatEncounter(
    ...
    defeatNodeId = "seal_breaker_defeat",
    xpReward = 70,
    goldReward = 20,
...
private val cinderEnvoyEncounter = CombatEncounter(
    ...
    defeatNodeId = "cinder_envoy_defeat",
    xpReward = 120,
    goldReward = 35,
...
private val loyalistAmbushEncounter = CombatEncounter(
    ...
    defeatNodeId = "loyalist_ambush_defeat",
    xpReward = 170,
    goldReward = 45,
...
private val sanctumSentinelEncounter = CombatEncounter(
    ...
    defeatNodeId = "sanctum_sentinel_defeat",
    xpReward = 190,
    goldReward = 50,
...
private val rightHandEncounter = CombatEncounter(
    ...
    defeatNodeId = "right_hand_defeat",
    xpReward = 220,
    goldReward = 60,
...
private val stonebeardSiegeEncounter = CombatEncounter(
    ...
    defeatNodeId = "stonebeard_siege_defeat",
    xpReward = 260,
    goldReward = 70,
...
private val fenmoorExtractionEncounter = CombatEncounter(
    ...
    defeatNodeId = "fenmoor_extraction_defeat",
    xpReward = 290,
    goldReward = 75,
...
private val unfinishedThingEncounter = CombatEncounter(
    ...
    defeatNodeId = "unfinished_thing_defeat",
    xpReward = 330,
    goldReward = 85,
...
private val memoryConfrontationEncounter = CombatEncounter(
    ...
    defeatNodeId = "memory_confrontation_defeat",
    xpReward = 370,
    goldReward = 95,
...
private val reprisalSquadEncounter = CombatEncounter(
    ...
    defeatNodeId = "reprisal_squad_defeat",
    xpReward = 410,
    goldReward = 105,
...
private val reliquaryThiefEncounter = CombatEncounter(
    ...
    defeatNodeId = "reliquary_thief_defeat",
    xpReward = 450,
    goldReward = 115,
...
private val chamberGuardianEncounter = CombatEncounter(
    ...
    defeatNodeId = "chamber_guardian_defeat",
    xpReward = 500,
    goldReward = 125,
...
private val ghostwriterEncounter = CombatEncounter(
    ...
    defeatNodeId = "ghostwriter_defeat",
    xpReward = 650,
    goldReward = 160,
...
private val patientVoiceEncounter = CombatEncounter(
    ...
    defeatNodeId = "patient_voice_defeat",
    xpReward = 700,
    goldReward = 170,
...
private val emberlowStragglersEncounter = CombatEncounter(
    ...
    defeatNodeId = "emberlow_stragglers_defeat",
    xpReward = 750,
    goldReward = 180,
...
private val greymoorUnravelingEncounter = CombatEncounter(
    ...
    defeatNodeId = "greymoor_unraveling_defeat",
    xpReward = 800,
    goldReward = 190,
...
private val duskmereThresholdEncounter = CombatEncounter(
    ...
    defeatNodeId = "duskmere_threshold_defeat",
    xpReward = 850,
    goldReward = 200,
...
private val sunderingGroundEncounter = CombatEncounter(
    ...
    defeatNodeId = "sundering_ground_defeat",
    xpReward = 900,
    goldReward = 210,
...
private val theReclamationEncounter = CombatEncounter(
    ...
    defeatNodeId = "the_reclamation_defeat",
    xpReward = 950,
    goldReward = 220,
...
private val wraithspireVigilEncounter = CombatEncounter(
    ...
    defeatNodeId = "wraithspire_vigil_defeat",
    xpReward = 1000,
    goldReward = 230,
...
private val theLastReachEncounter = CombatEncounter(
    ...
    defeatNodeId = "the_last_reach_defeat",
    xpReward = 1250,
    goldReward = 280,
