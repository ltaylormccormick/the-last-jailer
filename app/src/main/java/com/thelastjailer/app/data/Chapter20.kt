 ...
 * report. The reveal deepens rather than resolves XIX's mystery: the archivist has been dead for
 ...
 * confirming it has a real history with whatever is behind all of this. Deliberately doesn't name
 * the entity yet; the prisoner's answer is held for a future chapter.
 *
...
val chapter20Nodes: List<StoryNode> = listOf(
    StoryNode(
        ...
        narrativeText = """
            ...
            eleven years before any of them existed deserves more than a secondhand account.
        """.trimIndent(),
        choices = listOf(
            Choice(
                label = "\"I'll go alone. This deserves a direct look, not a delegation.\"",
                nextNodeId = "the_road_to_the_workshop",
    ...
    StoryNode(
        id = "the_road_to_the_workshop",
        chapterId = "chapter_20",
        title = "The Road to the Workshop",
        illustrationId = "road_away_from_tree",
        narrativeText = """
            The workshop sits half-collapsed at the edge of a village that stopped being a village
            sometime in the last decade, the kind of quiet abandonment that doesn't leave ruins so
            much as questions. Selvane's people marked the door. Nobody local, apparently, ever
            remembers seeing it open.
        """.trimIndent(),
        choices = listOf(
    ...
    StoryNode(
        ...
        narrativeText = """
            Dust doesn't explain everything. The workbench holds decades of notes in the same hand
            Ilsevet described, and near the back of the room, what's left of the man who
    ...
    StoryNode(
        ...
        narrativeText = """
            Whatever finished the work doesn't take kindly to being interrupted mid-page. It rises
            out of the dark at the back of the workshop the way water rises when something
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            plans this time, just a single line, in a hand gone suddenly less certain than all the
            pages before it:
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            starting to suspect nobody involved in any of this has ever been doing anything except
            finishing somebody else's very old, very patient work.
