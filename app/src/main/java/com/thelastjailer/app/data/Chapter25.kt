 ...
 * without ever actually confirming a yes. This escalates real stakes rather than repeating a third
 * ambiguous silence: a keeper's binding was actually surrendered, something took a first, small,
 * physical foothold through it, and Wren herself is gone rather than merely lost or grieving — a
 * genuinely new kind of cost. Twenty-fifth and toughest combat yet (The Answering Door, 340 HP — a
 * threshold given just enough shape to defend what it's climbing out of). Continues the decrementing
 * "how many fragments remain unaccounted for" count from XXIII/XXIV (two remaining there; one
 * remaining after this chapter), sharpening the endgame the story has been building toward.
 */
val chapter25Nodes: List<StoryNode> = listOf(
    StoryNode(
        ...
        narrativeText = """
            ...
            way Kaelen has never heard from it. "It already answered. I felt it happen."
        """.trimIndent(),
        choices = listOf(
            Choice(
                label = "\"Answered how?\"",
                nextNodeId = "what_the_prisoner_fears",
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            ask if she still could. I don't blame her for saying yes. I'm terrified of what saying
            yes to it does to the person who says it."
        """.trimIndent(),
        choices = listOf(
    ...
    StoryNode(
        ...
        narrativeText = """
            ...
            unfinished as it was before, and Wren nowhere to be found. Whatever "yes" cost her, it
            didn't leave a body behind to grieve, and Kaelen isn't sure yet if that's better or
            worse than Halvard's ending.
